...

{
	...
	m_ColourList[HVC_SELECTION]   = 0;//COLOR_HIGHLIGHT    | HEX_SYS_COLOR;
	...
	m_ColourList[HVC_HEXODDSEL]   = 0xdddddd;//COLOR_HIGHLIGHTTEXT| HEX_SYS_COLOR;//RGB(255, 255, 0);
	m_ColourList[HVC_HEXODDSEL2]  = COLOR_HIGHLIGHTTEXT| HEX_SYS_COLOR;//RGB(255, 255, 0);
	m_ColourList[HVC_HEXEVENSEL]  = 0xdddddd;//COLOR_HIGHLIGHTTEXT| HEX_SYS_COLOR;//RGB(255, 255, 127);
	...
	m_ColourList[HVC_ASCIISEL]    = 0xdddddd;//COLOR_HIGHLIGHTTEXT| HEX_SYS_COLOR;
