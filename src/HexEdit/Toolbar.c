...
TBBUTTON tbb[] = 
{
	{	0/*STD_FILENEW*/,	IDM_FILE_NEW,		TBSTATE_ENABLED,	TBSTYLE_BUTTON,  0,0,0, 0 },
	{	1/*STD_FILEOPEN*/,	IDM_FILE_OPEN,		TBSTATE_ENABLED,	TBSTYLE_BUTTON,  0,0,0, 1 },
	{	2/*STD_FILESAVE*/,	IDM_FILE_SAVE,		TBSTATE_ENABLED,	TBSTYLE_BUTTON,  0,0,0, 2 }, 
	{	0,				0,						TBSTATE_ENABLED,	TBSTYLE_SEP,	  0,0,0, 0 },
	{	3/*STD_CUT*/,		IDM_EDIT_CUT,		TBSTATE_ENABLED,	TBSTYLE_BUTTON,  0,0,0, 3 },
	{	4/*STD_COPY*/,		IDM_EDIT_COPY,		TBSTATE_ENABLED,	TBSTYLE_BUTTON,  0,0,0, 4 },
	{	5/*STD_PASTE*/,		IDM_EDIT_PASTE,		TBSTATE_ENABLED,	TBSTYLE_BUTTON/*|TBSTYLE_DROPDOWN*/,  0,0,0, 5 },
	{	0,				0,						TBSTATE_ENABLED,	TBSTYLE_SEP,	  0,0,0, 0 },
	{	6/*STD_UNDO*/,		IDM_EDIT_UNDO,		TBSTATE_ENABLED, TBSTYLE_BUTTON,  0,0,0, 6 },
	{	7/*STD_REDOW*/,		IDM_EDIT_REDO,		TBSTATE_ENABLED, TBSTYLE_BUTTON,  0,0,0, 7 },
	{	8/*STD_FIND*/,		IDM_SEARCH_FIND,	TBSTATE_ENABLED,	TBSTYLE_BUTTON,  0,0,0, 8 },
	{	0,				0,						TBSTATE_ENABLED,	TBSTYLE_SEP,	  0,0,0, 0 },
	{	10/*STD_FIND*/,		IDM_TOOLS_TYPEVIEW,	TBSTATE_ENABLED,	TBSTYLE_CHECK,  0,0,0, 9 },
	{	11/*STD_FIND*/,		IDM_HIGHLIGHT_MANAGE,	TBSTATE_ENABLED, TBSTYLE_CHECK,  0,0,0, 10 },
...
//	for(int j = 0; j < 11; j++)
	...
	SendMessage(hwndTB, TB_SETBUTTONSIZE, 0, MAKELONG(x+2,x-2));
	 sz = (DWORD)SendMessage(hwndTB, TB_GETBUTTONSIZE, 0, 0);
